...
import { ref } from 'vue'
import { simpleLoginAPI, wxLoginAPI, wxLoginBetaAPI } from '@/services/login'
...
const handleBetaLogin = async () => {
  const res = await wxLoginBetaAPI('13999999999')
...
const handlePhoneLogin = async () => {
  ...
  const res = await simpleLoginAPI({
...
<template>
  <view class="viewport">
    ...
    <view class="login">
      ...
      <button class="button phone" @tap="handlePhoneLogin">登录</button>
