  ...
  <view class="sk-container">
    <scroll-view :scroll-y="true" class="viewport viewport" :enable-back-to-top="true">
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-763 sk-text">286.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-630 sk-text"
            >厚底增高休闲运动老爹鞋</view
          >
          <view class="desc sk-transparent sk-text-0-0000-642 sk-text"
            >率性潮流马蹄底，悦享舒适app</view
          >
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-361 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-290 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-320 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-89 sk-text">
              请选择收获地址
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-982 sk-text">服务</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-269 sk-text">
              无忧退 快速退款 免费包邮
            </text>
          </view>
        </view>
      ...
      <view class="detail detail panel panel">
        <view class="title title">
          <text class="sk-transparent sk-text-0-0000-983 sk-text">详情</text>
        </view>
        <view class="content content">
          <view class="properties properties">
            <view class="item item">
              <text class="label sk-transparent sk-text-25-0000-233 sk-text">品牌信息</text>
              <text :user-select="true" class="value sk-transparent sk-text-25-0000-574 sk-text"
                >网易严选推荐选品，本产品为QM，由东莞市发现鞋业有限公司生产制造</text
              >
            </view>
          </view>
        </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 34px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-481 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-139 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
